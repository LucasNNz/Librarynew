...
checks={
  'version_0_20_46_everywhere': package.get('version')=='0.20.46' and cfpackage.get('version')=='0.20.46' and 'const EXPECTED_CORE_VERSION = "0.20.46"' in page and 'version: "0.20.46"' in index and 'version: "0.20.46"' in mcp,
  'schema_stays_2_26': 'const CONTRACT_VERSION = "2.26.0"' in schema_contract and not any((root/'cloudflare/migrations').glob('9027*.sql')),
  'source_bundle_is_unbuilt_0_20_46': 'CORE_WORKER_BUNDLE_VERSION: string = "UNBUILT"' in bundle and 'package.json (0.20.46)' in bundle,
...
report={
  'version':'0.20.46',
  'schema':'2.26.0',
  'feature':'Post-QA closure + direct MCP thumb file + internal imagens.zip manifest gate',
  'checks':checks,
...
out=root/'BEHAVIOR_GATE_0_20_46_POST_QA_CLOSURE_MEDIA_UPLOAD.json'
