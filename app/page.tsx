...
function slotTagGlow(tagKey:string){
  let hash=0;for(const char of String(tagKey||"TAG"))hash=(hash*31+char.charCodeAt(0))%360;
...
export default function Home() {
  ...
  // 0.20.59: no background polling here. MCP/GPT writes can be pulled with the
...
5. Atualizações normais preservam a configuração. Só Alterar configuração muda a infraestrutura.`;
  ...
  return <main className="shell shellV18">
    <aside className="sidebar sidebarV18">
      ...
      <a href="/quiz" className="panelButton" style={{margin:"12px",textAlign:"center"}}>▶ Quiz Teste</a>
