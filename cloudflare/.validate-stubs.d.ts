...
interface R2Bucket{get(key:string,opts?:{range?:{offset?:number;length?:number;suffix?:number}}):Promise<R2ObjectBody|null>;head(key:string):Promise<R2Object|null>;put(key:string,value:ReadableStream<Uint8Array>|Uint8Array|ArrayBuffer|string,opts?:unknown):Promise<R2Object|null>;delete(key:string|string[]):Promise<void>;list(opts?:{prefix?:string;limit?:number;cursor?:string;include?:Array<"httpMetadata"|"customMetadata">}):Promise<{objects:R2Object[];truncated:boolean;cursor?:string}>}
